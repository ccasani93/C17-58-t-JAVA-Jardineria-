...
export const Products = () => {
  return (
    <div className="flex flex-col items-center mt-9 md:flex md:flex-row md:gap-2 md:w-[100%] md:flex-center md:items-center md:justify-center md:mt-[5rem] md:mb-[3rem]">
      ...
      <ArrowRighIcon className="hidden md:block md:flex md:place-items-center md:justify-center" />
